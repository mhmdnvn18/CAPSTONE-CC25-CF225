...
## Penggunaan
Setelah menjalankan server frontend dan backend, buka browser dan akses `http://localhost:5173` untuk menggunakan aplikasi. Anda dapat memasukkan data kesehatan dan mendapatkan prediksi risiko penyakit kardiovaskular.
...
### Submit Prediction
- **POST** `/api/predict`: Mengirimkan data untuk prediksi risiko kardiovaskular.
...
## Kontribusi
Kami menyambut kontribusi dari semua orang. Silakan buka issue atau pull request untuk berkontribusi pada proyek ini.
...
Anda dapat menambahkan lebih banyak detail atau bagian sesuai dengan kebutuhan proyek Anda. Pastikan untuk memperbarui tautan dan informasi yang relevan.